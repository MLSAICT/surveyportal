...
// Select all elements with class "calendar"
var calendarElements = document.querySelectorAll(".calendar");

// Initialize Flatpickr for each calendar element
calendarElements.forEach(function(element) {
  flatpickr(element);
});

// Select all elements with class "clock"
var clockElements = document.querySelectorAll(".clock");

// Initialize Flatpickr for each clock element
